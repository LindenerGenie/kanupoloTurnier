...
class Ui_spielklassenDialog_c(object):
    def setupUi(self, spielklassenDialog_c):
        ...
        self.spielklassenListView = QtWidgets.QListView(spielklassenDialog_c)
        self.spielklassenListView.setObjectName("spielklassenListView")
        self.verticalLayout.addWidget(self.spielklassenListView)
